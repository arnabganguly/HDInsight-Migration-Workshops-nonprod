...
1. At the *bash* prompt, run command shown below to set the correct hostname for the virtual machine. You may be prompted by the **sudo** command for a password; enter the password you set up for the **azureuser** account.
    ...
    **NOTE:** 
    ...
    This step is necessary because the Cloudera installation is preconfigured with this hostname. If you leave it set at the default value generated by Azure, the Cloudera services will fail with DNS lookup errors.
